  ...
  return (
    ...
    />
        ...
        <div className="flex gap-4">
          ...
          <button className={`${!darkMode ? 'text-gray-600' : 'text-white'} hover:underline font-medium`}>Discover new hobbies …</button>
        </div>
      </div>
      ...
      <div className="relative mt-12 md:mt-0 w-full md:w-1/2 flex justify-center items-center">
        ...
        <FaBiking size={20} className="absolute bottom-10 right-14 text-gray-400 text-xl" />
