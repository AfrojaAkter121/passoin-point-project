    ...
    <section className="flex flex-col md:flex-row items-center justify-between px-6 py-10 md:py-20 max-w-7xl mx-auto">
      ...
      <div className="max-w-xl">
        ...
        <p className="text-gray-600 mb-6">
          Whether you're a seasoned enthusiast or a curious beginner, HobbyHub is the place to explore new interests, connect with like-minded individuals, and showcase your passion projects.
        </p>
        <div className="flex gap-4">
          <button className="bg-teal-700 hover:bg-teal-400 text-white px-6 py-2 rounded-md">Get Started</button>
          <button className="text-gray-700 font-medium hover:underline">Discover new hobbies …</button>
        </div>
      </div>
      ...
      <div className="relative mt-12 md:mt-0 w-full md:w-1/2 flex justify-center items-center">
        {/* Icons */}
        <FaSwimmer size={40} className="absolute top-0 left-20 text-gray-400 text-xl" />
        <FaBasketballBall size={40} className="absolute top-0 right-10 text-gray-400 text-xl" />
        <FaFutbol size={40} className="absolute bottom-20 left-12 text-gray-400 text-xl" />
        <FaBiking size={40} className="absolute bottom-10 right-14 text-gray-400 text-xl" />
